...
const SubStore: React.FC = () => {
  ...
  return (
    <>
      <BasePage
        title={t('pages.substore.title')}
        header={
          <div className="flex gap-2">
            <Button
              title={t('pages.substore.checkUpdate')}
              isIconOnly
              size="sm"
              ...
              onPress={async () => {
                try {
                  new Notification(t('pages.substore.updating'))
                  setIsUpdating(true)
                  ...
                  await getPort()
                  new Notification(t('pages.substore.updateComplete'))
                } catch (e) {
                  new Notification(`${t('pages.substore.updateFailed')}${e}`)
                } finally {
                  setIsUpdating(false)
                }
              }}
            ...
            <Button
              title={t('pages.substore.openInBrowser')}
              isIconOnly
              size="sm"
              className="app-nodrag"
              variant="light"
