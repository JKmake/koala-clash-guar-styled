...
const Override: React.FC = () => {
  ...
  return (
    <BasePage
      ref={pageRef}
      title={t('pages.override.title')}
      header={
        <>
          <Button
            size="sm"
            variant="light"
            title={t('pages.override.documentation')}
            isIconOnly
          ...
          <Button
            className="app-nodrag"
            title={t('pages.override.overrideHub')}
            isIconOnly
            variant="light"
            size="sm"
            onPress={() => {
      ...
      <div className="sticky top-0 z-40 bg-background">
        <div className="flex p-2">
          ...
          <Dropdown>
            ...
            <DropdownMenu
              onAction={async (key) => {
                if (key === 'open') {
                  ...
                  await addOverrideItem({
                    name: t('pages.override.newJavaScript'),
                    type: 'local',
            ...
            >
              <DropdownItem key="open">{t('pages.override.openLocalOverride')}</DropdownItem>
              <DropdownItem key="import">{t('pages.override.importRemoteOverride')}</DropdownItem>
              <DropdownItem key="new-yaml">{t('pages.override.newYAML')}</DropdownItem>
              <DropdownItem key="new-js">{t('pages.override.newJavaScript')}</DropdownItem>
            </DropdownMenu>
          </Dropdown>
        </div>
        <Divider />
