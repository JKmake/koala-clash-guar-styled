...
<p align="center">
  ...
  <br>
  <br>
  <a href="https://github.com/JKmake/GUAR/releases">
    <img src="https://img.shields.io/github/release/JKmake/GUAR/all.svg" alt="Releases">
  </a>
</p>
...
1. Скачайте `GUAR Clash_x64-setup.exe` со страницы [Releases](https://github.com/JKmake/GUAR/releases).
...
```bash
git clone https://github.com/JKmake/GUAR.git
cd GUAR
pnpm install
pnpm dev
```
